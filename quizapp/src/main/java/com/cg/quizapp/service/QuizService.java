...
import com.cg.quizapp.dao.QuizDao;
...
public class QuizService {
 ...
 for (Question q: questionsFromDB){
     QuestionWrapper qw= new QuestionWrapper(q.getQuestionTitle(),q.getOption4(),q.getOption3(),q.getOption2(),q.getOption1(),q.getId());
